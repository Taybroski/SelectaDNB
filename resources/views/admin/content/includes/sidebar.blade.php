<div class="card">
	...
	<div class="card-body minh-40">
		<ul class="list-group list-unstyled text-dark">
			...
			<a href="{{ url('/admin/header') }}"><li class="sidebar-item"><i class="fas fa-expand pr-2"></i>Header Image</li></a>
			<a href="#"><li class="sidebar-item"><i class="fas fa-table pr-2"></i>Portfolio</li></a>
			<a href="#"><li class="sidebar-item"><i class="fas fa-th pr-2"></i>Gallery</li></a>
		</ul>
	</div>
